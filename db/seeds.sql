...
VALUES
-- every one of these, in between the parentheses, is an individual row
-- being created inside of the parties table. 
-- the values given correspond to the fields specified in the parties table
-- schema.sql and they go in order, first value gets assigned to the name,
-- second gets assigned to description, then the row is inserted into the table.
